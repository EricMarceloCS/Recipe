package dev.ericmarcelo.recipe.bootstrap;

import dev.ericmarcelo.recipe.domain.*;
import dev.ericmarcelo.recipe.repositories.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
    	setDatabaseCategoryInit();
    	setDatabaseUnitOfMeasureInit();
        recipeRepository.saveAll(getRecipes());
        log.debug("Loading Bootstrap Data");
    }
    
    private void setDatabaseCategoryInit() {
    	...
    	this.categoryRepository.save(mexican);
    	this.categoryRepository.save(fastFood);
    	
    	
    }
    
    private void setDatabaseUnitOfMeasureInit() {
    	...
    	this.unitOfMeasureRepository.save(teaspoon);
    	this.unitOfMeasureRepository.save(tablespoon);
    	this.unitOfMeasureRepository.save(cup);
    	this.unitOfMeasureRepository.save(pinch);
    	this.unitOfMeasureRepository.save(ounce);
    	this.unitOfMeasureRepository.save(each);
    	this.unitOfMeasureRepository.save(dash);
    	this.unitOfMeasureRepository.save(pint);
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.addIngredient(new Ingredient("sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupsUom));
